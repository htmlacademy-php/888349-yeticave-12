...
-- SELECT l.name, l.price, l.img_link, c.name FROM lot l JOIN category c ON l.categoryId = c.id WHERE c.id = 3 ORDER BY l.created_date DESC;
SELECT IF ((SELECT NOW()) < (SELECT expiration_date FROM lot WHERE id=3), (SELECT l.name FROM lot l JOIN category c ON l.categoryId = c.id WHERE c.id = 3 ORDER BY l.created_date DESC), (''));
SELECT IF ((SELECT NOW()) < (SELECT expiration_date FROM lot WHERE id=3), (SELECT l.price FROM lot l JOIN category c ON l.categoryId = c.id WHERE c.id = 3 ORDER BY l.created_date DESC), (''));
SELECT IF ((SELECT NOW()) < (SELECT expiration_date FROM lot WHERE id=3), (SELECT l.img_link FROM lot l JOIN category c ON l.categoryId = c.id WHERE c.id = 3 ORDER BY l.created_date DESC), (''));
SELECT IF ((SELECT NOW()) < (SELECT expiration_date FROM lot WHERE id=3), (SELECT c.name FROM lot l JOIN category c ON l.categoryId = c.id WHERE c.id = 3 ORDER BY l.created_date DESC), (''));
